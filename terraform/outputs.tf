...
output "positions_table" {
  description = "Existing BigQuery table for positions data"
...
output "transactions_table" {
  description = "Existing BigQuery table for transactions data"
  value       = "${data.google_bigquery_dataset.mt5_trading.dataset_id}.${data.google_bigquery_table.transactions.table_id}"
}

output "prices_table" {
  description = "Existing BigQuery table for price updates data"
